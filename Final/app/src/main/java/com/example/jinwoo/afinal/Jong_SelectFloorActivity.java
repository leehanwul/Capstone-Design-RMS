...
public class Jong_SelectFloorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        floor_1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                try {
                    new Jong_SelectFloorActivity.JSONTask().execute("http://13.124.118.230:3000/view");
    ...
    public class JSONTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if(flag_1 == 1) {
                ...
                Intent intent2 = new Intent(getApplicationContext(), JonghabF1Activity.class);
                ...
                Intent intent2 = new Intent(getApplicationContext(), JonghabF2Activity.class);
                intent2.putExtra("info", result);
                Log.d("234d1", "&&&" + result);
                startActivity(intent2);
                ...
                Intent intent2 = new Intent(getApplicationContext(), JonghabF3Activity.class);
                intent2.putExtra("info", result);
                Log.d("234d1", "&&&" + result);
                startActivity(intent2);
                ...
                Intent intent2 = new Intent(getApplicationContext(), JonghabF4Activity.class);
                intent2.putExtra("info", result);
                Log.d("234d1", "&&&" + result);
                startActivity(intent2);
